...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="https://bettypasteleria.gogazo.com">Betty</a>
  ...
  <section class="home-slider owl-carousel js-fullheight">
    ...
    <div class="slider-item js-fullheight" style="background-image: url(imagenes/portada3.jpg);">
      <div class="overlay"></div>
      <div class="container">
    				...
    				<div class="featured">
    					<div class="row">
		                  ...
		                  <h3>Torta de chocolate</h3>
    						...
    						<div class="col-md-3">
    							<div class="featured-menus ftco-animate">
			              <div class="menu-img img" style="background-image: url(imagenes/cupcakes-rosa2.jpg);"></div>
			              <div class="text text-center">
		                  <h3>Cupcakes</h3>
			              </div>
			            </div>
    						...
    						<div class="col-md-3">
    							<div class="featured-menus ftco-animate">
			              <div class="menu-img img" style="background-image: url(imagenes/torta-helada-naranja-piña.jpg);"></div>
			              <div class="text text-center">
		                  <h3>Torta helada</h3>
			              </div>
			            </div>
    						...
    						<div class="col-md-3">
    							<div class="featured-menus ftco-animate">
			              <div class="menu-img img" style="background-image: url(imagenes/torta-chocolate-nombre.jpg);"></div>
			              <div class="text text-center">
		                  <h3>Torta personalizable</h3>
			              </div>
			            </div>
    						</div>
    					</div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-7 d-flex">
          <div class="img img-1 mr-md-2" style="background-image: url(imagenes/portada5.jpg);"></div>
          <div class="img img-2 ml-md-2" style="background-image: url(imagenes/portada6.jpg);"></div>
        </div>
        <div class="col-md-5 wrap-about pt-5 pt-md-5 pb-md-3 ftco-animate">
          <div class="heading-section mb-4 my-5 my-md-0">
            <span class="subheading">Betty</span>
            <h2 class="mb-4">Pastelería</h2>
          </div>
...
-->
  <section id="productos" class="ftco-section">
    <div class="container">
      ...
      <div class="row no-gutters d-flex align-items-stretch">
        ...
        <div class="col-md-12 col-lg-6 d-flex align-self-stretch">
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            <div class="menu-img img" style="background-image: url(imagenes/torta-chocolate-nombre2.jpg);"></div>
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                  <div class="one-half">
                    <h3>Torta de chocolate (1/2)</h3>
          ...
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            ...
            <div class="text d-flex align-items-center">
              <div>
                ...
                <p><span>Bañada en fudge</span>, <span>chocolate blanco rallado</span>, <span>chispas de chocolate </span> ,
                  <span>barquillos rellenos de manjar </span> y nombre</p>
                <p><a href="#" class="btn btn-primary">Ordenar</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            ...
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                  <div class="one-half">
                    <h3>Candy torta (1/4)</h3>
                  </div>
                  <div class="one-forth">
                    <span class="price">S/.33</span>
                  </div>
                </div>
                <p>Dulces variados y keke de naranja bañado en manjar</p>
                <p><a href="#" class="btn btn-primary">Ordenar</a></p>
          ...
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            ...
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                  <div class="one-half">
                    <h3>Cupcakes (docena)</h3>
                  </div>
                  <div class="one-forth">
                    <span class="price">S/.18</span>
                  </div>
                </div>
                <p><span>Crema de mantequilla (color personalizable)</span></p>
                <p><a href="#" class="btn btn-primary">Ordenar</a></p>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-12 col-lg-6 d-flex align-self-stretch">
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            <div class="menu-img img" style="background-image: url(imagenes/cupcakes-royal.jpg);height: 250px;"></div>
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                  <div class="one-half">
                    <h3>Cupcake (docena)</h3>
                  </div>
                  <div class="one-forth">
                    <span class="price">S/.18</span>
                  </div>
                </div>
                <p><span>Crema royal</span> y chispas de colores</p>
                <p><a href="#" class="btn btn-primary">Ordenar</a></p>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-12 col-lg-6 d-flex align-self-stretch">
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            <div class="menu-img img" style="background-image: url(imagenes/cupcakes.jpg);height: 250px;"></div>
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                  <div class="one-half">
          ...
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            ...
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                  <div class="one-half">
                    <h3>Torta Helada mediana</h3>
                  </div>
                  <div class="one-forth">
                    <span class="price">S/.23</span>
                  </div>
                </div>
                <p><span>Gelatina de naranja </span> y <span>crema de leche con piña</p>
                <p><a href="#" class="btn btn-primary">Ordenar</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            ...
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                  <div class="one-half">
                    <h3>Bombones (docena)</h3>
                  </div>
                  <div class="one-forth">
                    <span class="price">S/.6</span>
                  </div>
                </div>
                <p><span>Bañados en chocolate bitter</p>
                <p><a href="#" class="btn btn-primary">Ordenar</a></p>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-12 col-lg-6 d-flex align-self-stretch">
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            <div class="menu-img img " style="background-image: url(imagenes/helados.jpg);height: 270px;">
            </div>
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                ...
                <p><span>Cupcakes cubiertos de chocolate sobre cono de helado</span></p>
                <p><a href="#" class="btn btn-primary">Ordenar</a></p>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-12 col-lg-6 d-flex align-self-stretch">
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            <div class="menu-img img" style="background-image: url(imagenes/bombones2.jpg);height: 300px;"></div>
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                  <div class="one-half">
          ...
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            ...
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                  <div class="one-half">
                    <h3>Chocolates con dedicatoria</h3>
                  </div>
                  <div class="one-forth">
                    <span class="price">S/ --</span>
                  </div>
                </div>
                <p><span>Frases personalizables, precio varia de acuerdo a la frase</span></p>
                <p><a href="#" class="btn btn-primary">Ordenar</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            ...
            <div class="text d-flex align-items-center">
              <div>
                ...
                <p><span>Bombones bañandos en chocolate bitter</p>
                <p><a href="#" class="btn btn-primary">Ordenar</a></p>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-12 col-lg-6 d-flex align-self-stretch">
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            <div class="menu-img img" style="background-image: url(imagenes/dedicatoria2.jpg);height: 310px;"></div>
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                  <div class="one-half">
        ...
        <div class="col-md-12 col-lg-6 d-flex align-self-stretch">
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            <div class="menu-img img" style="background-image: url(imagenes/dedicatoria4.jpg);height: 250px;"></div>
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                  <div class="one-half">
        ...
        <div class="col-md-12 col-lg-6 d-flex align-self-stretch">
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            <div class="menu-img img" style="background-image: url(imagenes/chocotejas.jpg);height: 250px;"></div>
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                  <div class="one-half">
          ...
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            ...
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                  <div class="one-half">
                    <h3>Alfajores de maizena (docena)</h3>
                  </div>
                  <div class="one-forth">
                    <span class="price">S/.8</span>
                  </div>
                </div>
                <p><span>En forma de corazón, mickey , flor o circular</span></p>
                <p><a href="#" class="btn btn-primary">Ordenar</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            ...
            <div class="text d-flex align-items-center">
              <div>
                ...
                <p><span>Rellena de manjar y coco rallado</p>
                <p><a href="#" class="btn btn-primary">Ordenar</a></p>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-12 col-lg-6 d-flex align-self-stretch">
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            <div class="menu-img img" style="background-image: url(imagenes/alafjores-corazon.jpg);height: 250px;"></div>
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                  <div class="one-half">
        ...
        <div class="col-md-12 col-lg-6 d-flex align-self-stretch">
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            <div class="menu-img img order-md-last" style="background-image: url(imagenes/alafjores-mickey.jpg);height: 250px;"></div>
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                  <div class="one-half">
  ...
  <!--
		...
		<section class="ftco-section img" style="background-image: url(imagenes/portada4.jpg)" data-stellar-background-ratio="0.5">
			<div class="container">
				<div class="row d-flex">
      ...
      <div class="row mb-5">
        <div class="col-md-6 col-lg-4">
          <div class="ftco-footer-widget mb-4">
            <h2 class="ftco-heading-2">Betty</h2>
            <p>Elaboración de pasteles, cupcakes y bombones.</p>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="ftco-footer-widget mb-4">
            <h2 class="ftco-heading-2">Escríbenos al 971 280 491</h2>
            <!--
